...
namespace C____RPG
{
    ...
    public sealed partial class GamePage : Page
    {
        ...
        public GamePage()
        {
            ...
            missionReward.Text = "" + story.GetCurrentMission().reward + "xp";
        ...
        private void Start_Animation(Object sender, RoutedEventArgs e)
        {
            try
            {
              //Menu actions
                ...
                foreach (Item item in ShopTools)
                {
        ...
        void Click_buyResc(object sender, RoutedEventArgs e, Item tool, Button buttonWithContent)
        {
            try
            {
